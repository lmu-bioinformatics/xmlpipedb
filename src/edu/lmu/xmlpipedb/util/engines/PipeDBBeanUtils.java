...
/**
 * This class provides a series of static methods that will serve as helpers
...
public class PipeDBBeanUtils {
    ...
    public static boolean isPrimitive(Object o) {
        ...
        return className.startsWith("class java");
    }

    /**
     * Determines if the passed object is neither a reference to a primitive or
     * a collection.
     * 
     * @param o
     * @return True, if o references a primitive; false otherwise.
    ...
    public static boolean isObject(Object o) {
        return (!isPrimitive(o) && !isCollection(o));
    }
