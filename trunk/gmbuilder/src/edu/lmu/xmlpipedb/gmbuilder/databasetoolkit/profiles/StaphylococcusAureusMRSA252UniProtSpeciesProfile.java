...
public class StaphylococcusAureusMRSA252UniProtSpeciesProfile extends
	...
	public StaphylococcusAureusMRSA252UniProtSpeciesProfile (){
		super("Staphylococcus aureus MRSA 252", "This profile customizes the GenMAPP Builder export for Staphylococcus Aureus MRSA 252 data loaded from a UniProt XML file");
	}
	@Override
