...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
   ...
   /**
    ...
    private void initComponents() {
        ...
        backButton = new JButton(new ImageIcon(System.getProperty("user.dir")+ "/resource/images/backIcon.gif"));
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName(System.getProperty("user.dir")+ "/resource/images/");
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("properties.gmbuilder");
