...
alter table ProteinNameType drop constraint FKA7F500E84F778C54;
alter table ProteinNameType drop constraint FKA7F500E86E71769F;
alter table ProteinNameType drop constraint FKA7F500E89B183DCF;
...
create table EntryType_Comment (
    ...
    EntryType_Comment_Hjclass varchar(255),
...
create table NameListType_PersonOrConsortium (
    ...
    NameListType_PersonOrConsortium_Hjclass varchar(255),
...
create table SourceDataType_SpeciesOrStrainOrPlasmid (
    ...
    SourceDataType_SpeciesOrStrainOrPlasmid_Hjclass varchar(255),
