 ...
 * queries. The three implementations for addObject(...) were taken from the How
 * to Use Trees tutorial on Sun's JAva website.
 * 
 * @author Babak Naffas
 * @version 0.5
 * 
...
public class HQLResultTree extends JTree {
     ...
     * 
     * @param parent
     *            The node to which we are adding
     * @param child
     *            The data we are adding to <b>parent</b>
     * @param allowsChildren
     * @param shouldBeVisible
     * @return The added node
     */
    public DefaultMutableTreeNode addObject(DefaultMutableTreeNode parent, Object child, boolean allowsChildren, boolean shouldBeVisible) {
    ...
    /**
     * * Displays the list of object maintained in list in the tree. Primitive
     * fields are rendered as lead nodes, objects are rendered as parent nodes.
     * 
     * @param list
     *            The list of objects
     */
    ...
    private void populateObjects(Object property, Object value, DefaultMutableTreeNode root) {
        ...
        String label = getNodeLabel(property.toString(), value);
        if (PipeDBBeanUtils.isPrimitive(value)) {
            addObject(root, label, false, true);
        }
        // if field is a collection, add each of its entries seperately.
    ...
    private String getNodeLabel(Object key, Object value) {
