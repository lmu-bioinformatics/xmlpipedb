 ...
 * that a TallyEngine instance uses.  
 * 
 * @author geocoso2
 *
 */
public interface TallyEngineDelegate {
	...
	/**
	 * This method is called when a @see edu.lmu.xmlpipedb.util.engines.Criterion specified with a 
	 * @see edu.lmu.xmlpipedb.util.engines.FindBodyRule is parsed and matched.  The instance
	 * of this interface will receive the body of the found node.  This allows inline rule 
